...
function play() {
    ...
    switch(userChoice) {
      ...
      updateScore(status);
      handleModal(userChoice, randomChoice, status);
  
}

function handleModal(user, ran, stat) {
...
closeButton.addEventListener('click', () => {rulesModal.classList.remove('active')});